...
public partial class Formulas
{
    ...
    )
    {
        ...
        try
        {
            ...
            expression.Parameters["A_Attack"] = attacker.Stat[(int)Stat.Strength].Value();
            ...
            expression.Parameters["A_Intelligence"] = attacker.Stat[(int)Stat.Intelligence].Value();
            expression.Parameters["A_MagicResist"] = attacker.Stat[(int)Stat.Faith].Value();
            expression.Parameters["A_Level"] = attacker.Level;
            expression.Parameters["V_Attack"] = victim.Stat[(int)Stat.Strength].Value();
            ...
            expression.Parameters["V_Intelligence"] = victim.Stat[(int)Stat.Intelligence].Value();
            expression.Parameters["V_MagicResist"] = victim.Stat[(int)Stat.Faith].Value();
